# Инструкция по датасетам

Этот пакет подготовлен как offline-ready набор данных для продуктовых кейсов. Внутри есть CSV-таблицы, MP4-ролики видеоаналитики и уже разложенные данные по задачам в `tasks/*/data`.
...
- Данные не являются полным продовым срезом SKAI. Это curated-набор данных.
