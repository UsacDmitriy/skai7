...
| В345КМ 97 / Петров Д.С. | Датчик удара | ⚡📹 Оба | [▶] | 🟡 В работе | 15.05 | Открыть → |
...
## Промпт
> Готовый текст для вставки. **Полностью соответствует встроенной спеке и таблице данных выше**
> (KPI: всего 8 заявок, просрочено 1; 7 строк). Источник inc-002 (В345КМ 97) = **⚡📹 Оба (COMBINED)**.
> Severity border статусов по `00-design-system.md`: Новая/Просрочена #DC2626 · В работе #EA580C ·
> Проверена #1E3A8A · Закрыта #16A34A.
...
HEADER white border-b h-14 px-6 flex justify-between items-center:
  ...
  select "Все статусы" · select "Все источники" (📹 ВА · ⚡ Телематика · ⚡📹 Оба) · [Экспорт CSV]

KPI BAR white border-b px-6 py-3 flex gap-8 (числа 32px bold #1E3A8A):
  ТС В ЗОНЕ РИСКА: 4
  КРИТИЧНЫХ: 2 (#DC2626)
  ВСЕГО ЗАЯВОК: 8
  ПРОСРОЧЕНО: 1 (#DC2626)
...
ТАБЛИЦА (white, 100% width, border-collapse):
  Thead bg #F8FAFC text-xs uppercase text-slate-500 border-b:
    ТС / Водитель | Событие | Источник | Видео | Статус | Дедлайн | Действие
  Строки: border-left 4px severity-color, "Просрочена" — вся строка bg #FEF2F2.
  Status badges: Новая #FEE2E2/#991B1B · В работе #FEF3C7/#B45309 · Проверена #DBEAFE/#1E3A8A ·
    Закрыта #DCFCE7/#166534 · Просрочена #FEE2E2/#991B1B bold.

  Tbody — 7 строк:
  1 (#DC2626): А777ВВ 77 · Иванов А.П. | 😴 Засыпание за рулём | 📹 DMS | ▶ | [🔴 Новая] | 16.05 | [Открыть →]
  2 (#EA580C): В345КМ 97 · Петров Д.С. | 💥 Датчик удара | ⚡📹 Оба | ▶ | [🟡 В работе] | 15.05 | [Открыть →]
  3 (#EA580C): Е902СТ 150 · Сидоров В.Н. | 📱 Использование телефона | 📹 DMS | 📷 Нет видео | [🟡 В работе] | 15.05 | [Открыть →]
  4 (#1E3A8A): Н124УУ 199 · Козлов И.А. | 🛑 Резкое торможение | ⚡ Телематика | ▶ | [🔵 Проверена] | — | [Открыть →]
  5 (#DC2626): К451МА 77 · Новиков А.В. | 🔄 Замена водителя | ⚡📹 Оба | ▶ | [🔴 Новая] | 16.05 | [Открыть →]
  6 (#DC2626, строка bg #FEF2F2): Р788ОО 52 · Тихонов М.С. | 📷 Камера офлайн | ⚙ Диагностика | — | [🔴 Просрочена] | 14.05 | [Открыть →]
  7 (#16A34A): Т901ПА 97 · Власов Е.Д. | ⚠ FCW опасное сближение | 📹 ADAS | ▶ | [🟢 Закрыта] | — | [Открыть →]
