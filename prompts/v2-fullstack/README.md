...
```text
   ...
   d5 voice-timeline          b6 routers                    f5 events-feed
        ...
        └───────────────────────────┼───────────────────────────┘
                                     ▼
                      barrier-1-integration-p0 (барьер 1)
...
3. **Барьер 1 — интеграция P0.** После завершения D/B/F запускается барьер 1 (`barrier-1-integration-p0`): x1 выпил Streamlit → x2 склейка React↔FastAPI → x3 сквозной smoke.
