...
> **2.1 Reports & Voice + P0-доработки** (b7→b10, b8∥b9, b14 ‖ d5,f7,f14 → x4a) · **2.2 Прикладные экраны** (b11∥b12∥b13 ‖ d4,f5,f6,f8–f13 → x4b)
...
4. **Волна 2 — расширение P1/P2** (3 фич-подволны с промежуточными барьерами):
   - **2.1 Reports & Voice (+ P0-доработки b14/f14)** — b7→b10, b8∥b9, b14 ‖ d5,f7,f14 → **Барьер 2.1** (`x4a` smoke отчёты/voice, `main` не трогает). `b14`/`f14` доводят enrichment/IncidentCard (Волна 1) до DoD поверх готового кода.
