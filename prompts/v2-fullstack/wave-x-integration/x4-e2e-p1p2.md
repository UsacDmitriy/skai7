...
Волну 2 (b7–b13, d4/d5, f5–f13) в `integration` уже слил **x2** (его «Перед стартом», идемпотентная склейка),
роутеры b11–b13 подключены авто-обходом. **x4 ничего не мерджит** — только финальный smoke и продвижение `main`.
