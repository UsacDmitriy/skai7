...
Video paths in `video_files.csv` are relative to the unpacked project/archive root, for example `datasets/media/video_events/...`. When running from this task folder, resolve them through `../../`.
