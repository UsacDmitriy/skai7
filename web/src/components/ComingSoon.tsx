 ...
 * ощущения пустого 404 — название секции, одна строка описания и пилюля
 * «Скоро · Волна N». Карта `path → props` живёт в `App.tsx`.
 */
...
export function ComingSoon({ title, description, wave }: ComingSoonProps) {
  return (
